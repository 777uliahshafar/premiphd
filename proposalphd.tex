...
Tipikal Ruang publik terbaru di Parepare

\subsection{Research Objectives}

Karakteristik beberapa ruang publik di Parepare
...
\cite{ahmadi2009} menegaskan bahwa ruang publik memiliki karakter yang berbeda. Karakter tersebut menjelaskan tentang apa yang ada pada lingkungan fisik dan sosial \citep{dougherty2006}. Sementara \cite{hartanti2014} menyebut elemen fisik, aktivitas dan suasana sebagai sebuah pembentuk karakter. Meskipun demikian, sejumlah penelitian karakter adalah hasil dari permintaan dalam pemenuhan kebutuhan dan cerminan dari keadaan masyarakat sekitar.

%Beberapa karakter ruang publik yang menarik memiliki peran ekonomi, fisik dan psikologi. Peran ini mendukung kebutuhan masyarakat seperti mencari nafkah, pemulihan jiwa, dan kesehatan.
%Jelas, karakteristik dari ruang publik ini merupakan hasil dari permintaan dalam pemenuhan kebutuhan dan cerminan dari keadaan masyarakat.
